 ...
 */(private val label: String) {
    DOOR("DOOR"), WINDOW("WINDOW"), MOTION("MOTION"), FIRE("FIRE"), CARBONMONOXIDE("CARBONMONOXIDE"), SMOKEDETECTOR(
        "SMOKEDETECTOR"
    );

    companion object {
        private val log = LoggerFactory.getLogger(SType::class.java)
        ...
        init {
            for (e in values()) {
                BY_LABEL[com.example.safehome.Sensors.e.label] = com.example.safehome.Sensors.e
            }
